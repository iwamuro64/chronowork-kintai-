...
<body>
	...
	<div class="menu">
		<div class="main_frame">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<!-- 勤怠確認ボタン -->
							<form
								action="${pageContext.request.contextPath}/AdminAttendanceDetailServlet"
								method="get">
								<input type="hidden" name="employeeId"
									value="<%=employee.getEmployeeId()%>"> <input
									type="submit" value="勤怠確認" class="button">
							</form>
						</td>
						<td>
							<!-- 編集ボタン -->
							<form
								action="${pageContext.request.contextPath}/AdminEmployeeEditServlet"
								method="get">
								<input type="hidden" name="employeeId"
									value="<%=employee.getEmployeeId()%>"> <input
									type="submit" value="編集" class="button">
							</form>
						</td>
						<td>
							<!-- 削除ボタン -->
							<form
								action="${pageContext.request.contextPath}/AdminEmployeeDeleteServlet"
								method="post" onsubmit="return confirm('本当に削除しますか？');">
								<input type="hidden" name="employeeId"
									value="<%=employee.getEmployeeId()%>"> <input
									type="submit" value="削除" class="button">
							</form>
						</td>
					</tr>
					<%
			...
			<!-- TOPボタン -->
			<form
				action="${pageContext.request.contextPath}/mainJsp/adminMenu.jsp"
				method="get">
